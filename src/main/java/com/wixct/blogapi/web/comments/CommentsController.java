package com.wixct.blogapi.web.comments;


import com.wixct.blogapi.web.util.DateUtil;
import com.wixct.blogapi.jfinal.model.Comments;
...
public class CommentsController extends Controller {
	...
	*/
	...
	public void index() {
		render("/page/comments/commentsList.html");
	}
	...
	public Object show(//@ApiParam("项目名称") @RequestParam(value="pjname",defaultValue="",required=false) String pjname,
		...
		sql_exp.append("from t_comments a where 1=1 ");
...
//		sql_exp.append("order by a.UPDATE desc");
		...
		Page<Comments> pages= Comments.dao.paginate(pageNum,pageSize,sql_select.toString(),sql_exp.toString(),params.toArray());
