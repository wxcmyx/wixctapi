package com.wixct.blogapi.web.options;


import com.wixct.blogapi.web.util.DateUtil;
import com.wixct.blogapi.jfinal.model.Options;
...
public class OptionsController extends Controller {
	...
	*/
	private static final Logger logger = LoggerFactory.getLogger(OptionsController.class.getName());



	public void index() {
		render("/page/options/optionsList.html");
	}

	@ApiOperation("GITHUB项目列表")
	@RequestMapping(value="/options/show",method= RequestMethod.GET)
	@ResponseBody
	public Object show(//@ApiParam("项目名称") @RequestParam(value="pjname",defaultValue="",required=false) String pjname,
		...
		sql_exp.append("from t_options a where 1=1 ");
...
//		sql_exp.append("order by a.UPDATE desc");
		...
		Page<Options> pages= Options.dao.paginate(pageNum,pageSize,sql_select.toString(),sql_exp.toString(),params.toArray());
